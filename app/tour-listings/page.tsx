...
const PRODUCTS = [
  {
    ...
    image: "/images/tour-listings/cards/gallery-1.png",
    price: "$45",
    originalPrice: "$60",
    rating: 4.8,
    reviews: 312,
  ...
  },
  {
    ...
    image: "/images/tour-listings/cards/product-1.png",
    price: "$100",
    originalPrice: "$120",
    rating: 4.9,
    reviews: 311,
  ...
  },
  {
    ...
    image: "/images/tour-listings/cards/product-2.png",
    price: "$100",
    originalPrice: "$120",
    rating: 4.9,
    reviews: 311,
  ...
  },
  {
    ...
    image: "/images/tour-listings/cards/product-3.png",
    price: "$100",
    originalPrice: "$120",
    rating: 4.9,
    reviews: 311,
...
export const metadata = {
  ...
  alternates: {
    canonical: `${siteUrl}/tour-listings`,
  },
};
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {PRODUCTS.map((product, index) => (
                ...
                >
                  <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-brand-orange/10 xl:hover:shadow-lg transition-all duration-300">
                    {/* Image */}
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="font-display italic font-semibold text-lg text-brand-brown mb-2 xl:group-hover:text-brand-orange transition-colors">
                        {product.title}
                      </h3>
