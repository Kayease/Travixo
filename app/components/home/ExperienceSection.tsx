...
const ExperienceCard = ({
  ...
  <div className={`flex flex-col items-center ${offset ? "lg:mt-8" : ""}`}>
    ...
    {/* CTA Button */}
    <button className="mt-6 w-[300px] h-[50px] bg-white border border-brand-orange rounded-[12px] font-display italic text-[18px] leading-[24px] text-brand-orange overflow-hidden transition-all duration-300 relative group">
