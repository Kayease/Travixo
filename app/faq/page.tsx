  ...
  return (
    <section className="relative w-full py-8 md:py-12 lg:py-[60px] bg-[#FFF7E5]">
      <div className="max-w-[1080px] mx-auto px-5 md:px-10 text-center">
        ...
        <a
          href="/contact"
          className="inline-flex items-center justify-center rounded-[12px] font-display italic font-normal transition-all duration-300 active:scale-95 focus:outline-none relative overflow-hidden group px-6 py-2.5 text-[18px] leading-[24px] bg-brand-orange border border-brand-orange text-white"
        >
