                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4 overflow-y-auto">
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                        ...
                        <Button
                            ...
                            disabled={isSubmitting}
                            variant="primary"
                            className="!min-w-[200px] !max-w-[200px] !min-h-[48px] !max-h-[48px] !p-0 rounded-lg! flex items-center justify-center"
                        >
                            <div className="flex items-center justify-center gap-2 w-full h-full">
                                {isSubmitting ? (
                                    <>
                                        ...
                                        <span className="shrink-0">Submitting</span>
                                    </>
                                ) : (
                                    <span className="shrink-0">Submit Review</span>
                                )}
                            </div>
                        </Button>
                    </div>
