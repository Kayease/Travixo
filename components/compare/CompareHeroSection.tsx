/**
 * CompareHeroSection Component
 * 
 * Hero section for the Compare Experiences page displaying
 * the page title and a descriptive subtitle on a cream background.
 * 
 * Design specs from Figma:
 * - Container: 1440x285px, background #FFF7E5
 * - Title: "Compare Our Experiences" - Playfair Display italic, 28px, 600 weight
 * - Subtitle: Poppins medium, 18px, max-width 589px
 */

import React from 'react';

const CompareHeroSection: React.FC = () => {
  return (
    <section
