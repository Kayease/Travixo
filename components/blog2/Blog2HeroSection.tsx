    ...
    <section className="relative w-full bg-[#FFF7E5] h-[285px] flex items-center justify-center">
      <div className="max-w-[1440px] mx-auto px-5 md:px-10 lg:px-20 w-full">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <h1 className="font-display italic font-semibold text-[28px] leading-[37px] text-[#4B3621] text-center mb-6">
            Our Journal
          </h1>

          {/* Subtitle - positioned at top: 157px */}
          <p className="font-body font-medium text-[18px] leading-[30px] text-[#4B3621] text-center max-w-[415px]">
