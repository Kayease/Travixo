...
const StayHeroSection: React.FC = () => {
  return (
    <section className="w-full bg-[#FFF7E5] py-12 md:py-20">
      <div className="container mx-auto px-4 md:px-6 lg:px-20">
        ...
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
          ...
          {/* Description */}
          <p className="text-base md:text-lg font-medium leading-[26px] md:leading-[30px] text-[#4B3621] max-w-[340px] md:max-w-[589px]">
