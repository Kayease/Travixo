  ...
  return (
    <section className="w-full bg-[#FFFCF5] py-12 md:py-16 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 lg:px-20">
        ...
        ============================================ */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-8 max-w-[769px]">
          <h2 className="font-display text-2xl md:text-[28px] italic font-semibold leading-[37px] text-[#4B3621]">
            Customer reviews
          </h2>
