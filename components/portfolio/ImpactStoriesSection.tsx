...
const ImpactStoriesSection: React.FC = () => {
  return (
    <section className="relative w-full bg-[#FFF7E5] py-12 md:py-16 lg:py-[52px]">
      <style jsx>{`
        /* Landscape mobile devices (e.g. iPhone 14 Pro Max) */
      ...
      <div className="max-w-[1440px] mx-auto px-5 md:px-10 lg:px-10 xl:px-20">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-10 xl:gap-24">
          ...
          <div className="relative w-full lg:w-[500px] xl:w-[630px] shrink-0 impact-image-wrapper">
            {/* Main Image */}
          ...
          {/* Right: Content */}
          <div className="flex-1 pt-8 lg:pt-20 xl:pt-28 impact-content-wrapper">
            {/* Section Title */}
            ...
            {/* Description */}
            <p className="font-body font-medium text-base md:text-lg leading-[28px] md:leading-[30px] text-brand-brown mb-8 md:mb-10 max-w-[543px] impact-description">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 impact-feature-item">
                {/* Leaf Icon */}
