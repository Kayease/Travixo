      ...
      <div className="max-w-[1280px] mx-auto px-5 md:px-10 lg:px-20">
        <div className="text-center">
          ...
          <p className="font-body font-medium text-[16px] md:text-[18px] leading-[30px] text-brand-brown max-w-[780px] mx-auto">
            Log in to access your bookings and continue your adventure
          </p>
        </div>
      </div>
    </section>
...
const LoginFormSection = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[540px] mx-auto px-5 md:px-10">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4 h-4 rounded border-gray-300 text-brand-orange focus:ring-brand-orange cursor-pointer"
                />
