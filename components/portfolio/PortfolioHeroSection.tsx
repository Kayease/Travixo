/**
 * PortfolioHeroSection Component
 * 
 * Hero section for the Portfolio/Global Footprint page displaying
 * the page title and a descriptive subtitle on a cream background.
 * 
 * Design specs from Figma:
 * - Container: 1440x285px, background #FFF7E5
 * - Title: "Our Global Footprint" - Playfair Display italic, 28px, 600 weight
