...
export const metadata = {
    ...
    description: 'Stay updated with the latest travel news, tips, destination guides, and industry insights from Travixo.',
};
...
const FEATURED_ARTICLE = {
    ...
    excerpt: 'Discover the most breathtaking and undiscovered destinations across Southeast Asia that offer authentic cultural experiences and stunning natural beauty.',
...
const NEWS_ARTICLES = [
    {
        ...
        excerpt: 'Learn practical tips and strategies to make your travels more eco-friendly and sustainable.',
    ...
    },
    {
        ...
        excerpt: 'Planning a trip to Thailand? Discover the best months to visit based on weather, festivals, and tourist seasons.',
    ...
    },
    {
        ...
        excerpt: 'Elevate your travel photography with these expert tips and techniques for stunning vacation photos.',
    ...
    },
    {
        ...
        excerpt: 'Understanding and respecting local customs is essential for meaningful travel experiences.',
    ...
    },
    {
        ...
        excerpt: 'Discover how to travel on a budget with our comprehensive guide to affordable adventures.',
                ...
                <section className="relative w-full bg-[#FFF7E5] py-12 md:py-16 lg:py-20">
                    <div className="max-w-[1440px] mx-auto px-5 md:px-10 lg:px-20 text-center">
                        ...
                        <p className="font-body font-medium text-base md:text-lg leading-[30px] text-brand-brown max-w-[800px] mx-auto">
                            Stay informed with the latest travel trends, destination guides, tips, and stories from around the globe.
                        </p>
                    </div>
                </section>
                ...
                <section className="relative w-full bg-brand-orange py-16 md:py-20">
                    <div className="max-w-[1440px] mx-auto px-5 md:px-10 lg:px-20 text-center">
                        ...
                        <p className="font-body font-medium text-base md:text-lg leading-[30px] text-white/90 mb-8 max-w-[600px] mx-auto">
                            Subscribe to our newsletter and get the latest travel news, tips, and exclusive offers delivered to your inbox.
                        </p>
