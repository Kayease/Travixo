      ...
      <div className="max-w-[1440px] mx-auto px-20">
        ...
        <div className="flex flex-col gap-[12px] mb-[52px]">
          {blogPosts.map((post) => (
            <article
              key={post.id}
              className="bg-white border border-black/20 shadow-[0px_0px_4px_rgba(0,0,0,0.1)] rounded-xl w-[1280px] h-[417px] mx-auto flex items-center px-[18px] gap-[18px]"
            >
              {/* Image */}
              <div className="relative w-[511px] h-[381px] rounded-xl overflow-hidden shrink-0">
                <Image
                  src={post.image}
                  alt={post.title}
                  fill
              ...
              {/* Content */}
              <div className="flex-1 flex flex-col justify-center relative h-[381px]">
                {/* Title */}
                ...
                {/* Description */}
                <p className="font-body font-normal text-[20px] leading-[30px] text-[#4B3621] mb-[18px]">
                  {post.description}
                </p>

                {/* Date */}
                <p className="font-body font-normal text-[18px] leading-[27px] text-[#4B3621] text-center mb-[18px]">
                  {post.date}
                </p>
                ...
                <a
                  href="#"
                  className="flex items-center gap-2 font-body font-normal text-[14px] leading-[17px] text-[#4B3621] hover:text-[#FF6E00] transition-colors"
                >
                  <span>Read More</span>
                  <svg
                    width="20"
