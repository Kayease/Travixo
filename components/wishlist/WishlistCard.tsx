...
const WishlistCard: React.FC<WishlistCardProps> = React.memo(({
  ...
  const isInCartState = isInCart(item.title);
  // Render star rating
          ...
          <div className="relative w-full aspect-382/283 rounded-xl overflow-hidden mb-4">
            ...
            <div className="absolute top-3 right-3 flex flex-col gap-2 translate-x-12 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-500 ease-out z-20">
              ...
              <button
                ...
                className={`w-[30px] h-[30px] rounded-full flex items-center justify-center transition-colors duration-300 cursor-pointer ${isInCartState
                  ? "bg-[#FF6E00] text-white"
                  : "bg-white hover:bg-[#FF6E00] text-[#4B3621] hover:text-white"
                  }`}
